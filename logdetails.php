...
if (isset($_GET['getlogs'])) {
...
} else if (isset($_POST['notifyofmention'])) {
	...
	$notification = json_decode($_POST['notifyofmention'], true);
	$notification['description'] = $_SESSION['first'] . " " . $_SESSION['last'] . " Mentioned You in a Log.";
